...
SECRET_KEY = 'django-insecure-b2gpo*1lcgo@9i9mu9^!-7a@xbb9s%%5%j^0-18gp_&yilxwvl'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'edificio_db',
        'USER': 'evapani',
        'PASSWORD': '101292',  # déjalo vacío si usas WSL sin contraseña
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
SWAGGER_SETTINGS = {
    'SECURITY_DEFINITIONS': {
        'Bearer': {
            ...
            'in': 'header',
            'name': 'Authorization',
            'description': "Introduce tu token con el prefijo **Bearer**, por ejemplo: `Bearer tu_token_aquí`",
        }
    },
    'USE_SESSION_AUTH': False,  # <- evita que Swagger use autenticación por sesión
}
...
# Celery Beat: usar el scheduler de base de datos
